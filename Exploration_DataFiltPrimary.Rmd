...
# removed for size considerations    
...
#    
  ...
  # point data for measured error vs HPEs   -   removed to reduce knit-time
...
```{r}
  ...
  percKeep <- (nKeepHpe/(nLowHpe+nHighHpe+nKeepHpe))*100
    ...
    highhpe = ggplot(data=alldfg[alldfg$Hpes>=5 ,], #& alldfg$Hpes<500,], 
      ...
      scale_y_continuous(breaks=seq(38.758,38.764,0.001), limits=c(38.758,38.764)) + 
      scale_x_continuous(breaks=seq(-121.672, -121.664, 0.001), limits=c(-121.672, -121.664)) +
      coord_fixed() + 

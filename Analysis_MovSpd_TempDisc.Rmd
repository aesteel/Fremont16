...
```{r plot spds, echo=FALSE}
  ...
  ## plot speed by RelEv
  boxplot(pathspd$mps ~ pathspd$RelEv, xlab="Release Event", ylab=expression("Ground Speed (m s"^"-1)"), main="Reach-scale Ground Speed by Release Event")

  ## plot speed by mean iver stage

...
```{r kud 16 all fish, echo=FALSE}
    ...
    #kud16.lscv = kernelUD(red8.grp[,1], h="LSCV", kern="bivnorm", extent=0.1)
    ...
    # saveRDS(kud16.lscv, "Maestros/kud16_lscv.RData")
     ...
     kud16.lscv.old = readRDS("Maestros/kud16_lscv.RData") # has grid of 10.3 x 10.3  -  don't know why this ran previously but now it won't. =/
      print(paste0("smoothing parameter h, lscv; 2016-LFC = ",round(kud16.lscv.old$LFC@h$h,3)))
...
```{r, echo=FALSE, fig.width=7, fig.height=10}        
     vud16.lscv <- getvolumeUD(kud16.lscv.old)
     vud16.href <- getvolumeUD(kud16.href)
     vud16.h15 <- getvolumeUD(kud16.h15) 

#  windows(width=10, height=3); 
      par(mfrow=c(1,3))
     image(vud16.lscv[[1]], col=heat.colors(12), main="LFC-old 2016; h=LSCV")
